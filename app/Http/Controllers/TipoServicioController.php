...
class TipoServicioController extends Controller
{
    ...
    {
        $tiposervicio = DB::table('tipo_servicio')->get();
    ...
    {
        $tipo_servicio = TipoServicio::findOrFail($request->idtipo_servicio);
    ...
    {
        DB::table('tipo_servicio')->where('idtipo_servicio', $id)->delete();
